...
void main()
{
	...
	vec3 negRefractCross = cross(-fragNormal, -cdir);
	vec3 refractDirection =
		(material.refractionConstant) * cross(fragNormal, negRefractCross)
		- fragNormal * sqrt(1.0 - pow(material.refractionConstant, 2.0) *
